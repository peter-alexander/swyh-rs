...
This fork adds live **MP3** re-encoding at 320 kbps CBR. MP3 input sample rates are limited to the MPEG Layer III rates up to 48 kHz; 44.1 and 48 kHz require no resampling.
...
- **MP3** (MPEG Layer III), 320 kbps CBR, for renderers and internet-radio clients that need a lossy stream
...
- `http://{your-pc-ip}/stream/swyh.mp3` when streaming MP3 format (live 320 kbps CBR)
